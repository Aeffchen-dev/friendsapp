      ...
      case 'identity':
        return { 
          ...
          gradient: `
            ${shadows.topRight},
            ${shadows.topLeft},
            ${buildAuraGradient(glow.secW, glow.mainH * 1.2, glow.mainX + 15, glow.mainY - 10, 255, 160, 120, 0.55)},
            ${buildAuraGradient(glow.mainW * 0.8, glow.secH, glow.secX - 10, glow.secY + 5, 255, 120, 100, 0.5)},
            ${buildAuraGradient(glow.terW * 1.3, glow.terH * 0.7, glow.terX, glow.terY, 255, 100, 80, 0.45)}
          `
        };
      case 'career':
        return { 
