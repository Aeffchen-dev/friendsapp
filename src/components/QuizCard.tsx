      ...
      >
        ...
        <div className="ml-8 lg:ml-10 h-full flex flex-col justify-center px-8 lg:pr-10">
          ...
          <div className="absolute bottom-4 right-4 flex gap-4">
            {/* Share/Upload Icon */}
            <svg width="24" height="24" viewBox="0 0 1080 1080" className="cursor-pointer hover:opacity-80 transition-opacity">
              <polygon fill="white" points="213.45 1005.72 901.95 1005.72 901.95 502.84 652.99 502.84 652.99 556.84 847.95 556.84 847.95 951.72 267.45 951.72 267.45 556.84 462.41 556.84 462.41 502.84 213.45 502.84 213.45 1005.72"/>
              <polygon fill="white" points="530.74 417.39 530.74 784.71 584.74 784.71 584.74 417.39 584.74 302.24 584.74 192.35 694.63 302.24 770.99 302.24 554.13 85.37 554.13 158.52 478.93 158.52 335.22 302.24 335.22 302.24 411.58 302.24 530.74 183.08 530.74 302.24 530.74 417.39"/>
            </svg>
            
            {/* Heart/Favorite Icon */}
            <svg width="24" height="24" viewBox="0 0 1080 1080" className="cursor-pointer hover:opacity-80 transition-opacity">
              <path fill="white" d="M853.74,314.83c-31.46-34.17-74.16-56.08-120.26-61.72-46.09-5.63-92.83,5.35-131.58,30.94l-36.27,23.95-36.27-23.95c-38.76-25.58-85.49-36.57-131.59-30.94-46.1,5.63-88.81,27.55-120.26,61.72-66.88,72.64-69.08,184.15-5.11,259.38l293.23,344.86,35.07-41.24-34.72-42.53-.34.41-252.09-296.48c-46.32-54.47-44.73-135.22,3.7-187.82,22.78-24.74,53.71-40.61,87.08-44.69,5.72-.7,11.45-1.04,17.16-1.04,27.64,0,54.87,8.09,78.13,23.45l66.02,43.58,66.02-43.58c28.07-18.53,61.91-26.48,95.28-22.4,33.38,4.08,64.31,19.95,87.08,44.69,48.43,52.6,50.02,133.35,3.7,187.82l-219.24,257.83,37.01,39.84,223.37-262.69c63.96-75.22,61.76-186.73-5.11-259.38Z"/>
            </svg>
          </div>
        </div>
      </div>
