      ...
      case 'party':
        return { 
          ...
          gradient: `
            ${shadows.topRight},
            ${shadows.topLeft},
            ${buildAuraGradient(glow.mainW, glow.mainH, glow.mainX, glow.mainY, 255, 80, 100, 0.75)},
            ${buildAuraGradient(glow.secW, glow.secH, glow.secX, glow.secY, 255, 100, 220, 0.65)},
            ${buildAuraGradient(glow.terW, glow.terH, glow.terX, glow.terY, 220, 80, 255, 0.6)}
          `
        };
      case 'family':
        return { 
